...
class ImageList extends StatefulWidget {
  ImageList({Key key, this.imagesType, this.onDelete, this.onUpdate})
      : super(key: key);
            ...
            return GestureDetector(
                ...
                onTap: () async {
                  ...
                  Uint8List editedImage = await Navigator.push(
                      context,
                      PageRouteBuilder(
                          pageBuilder: (_, __, ___) => EditImage(
                                image: imageType.image,
                                type: imageType.type,
                              )));
                  widget.onUpdate(
                      editedImage, widget.imagesType.indexOf(imageType));
                  //setState(() { });
                  // setState(() {
        ...
        child: AlertDialog(
          ...
          actions: [
            ...
            new FlatButton(
                ...
                onPressed: () async {
                  widget.onDelete(
                      {"type": imageType.type, "image": imageType.image});
                  Navigator.pop(context);
                })
          ],
        ));
